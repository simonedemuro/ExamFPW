...
--
-- Name: view_user_totslot; Type: VIEW; Schema: public; Owner: fpw
--

CREATE VIEW public.view_user_totslot AS
 SELECT u.username,
        CASE
    ...
    u.phone,
        ...
        END AS invoiceoptin,
        CASE
            WHEN (sum(i.num_reserved_slot) IS NULL) THEN (0)::bigint
            ELSE sum(i.num_reserved_slot)
        END AS tot_num_res
   FROM (public."user" u
...
ALTER TABLE public.view_user_totslot OWNER TO fpw;
...
1	11	5	ciao	2021-01-01	ciao	5
3	12	55	descrizione processazione	2021-09-14	Dal: 2021-09-01 AM Al: 2021-09-01 AM	1
5	12	55	opt in si	2021-09-15	Dal: 2021-09-01 AM Al: 2021-09-02 PM	2
6	13	55	balneato molto	2021-09-16	Dal: 2021-09-01 AM Al: 2021-09-03 AM	2
7	13	50	sei un hacker	2021-09-16	Dal: 2021-09-01 AM Al: 2021-09-03 AM	-1
\.
...
9	13	2021-09-16	1	Dal: 2021-09-01 AM Al: 2021-09-03 AM
11	13	2021-09-16	-1	Dal: 2021-09-01 AM Al: 2021-09-03 AM
\.
...
13	f	matteo	ciao	matteo	fenu	2021-06-01	ijfdodsmoamfakom	M	okfkodsam@oijasi	498894948949	t
\.
...
SELECT pg_catalog.setval('public."available_slot_Id_seq"', 35, true);
